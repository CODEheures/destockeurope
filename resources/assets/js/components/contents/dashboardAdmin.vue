                ...
                <div class="ui grid">
                    ...
                    <div class="eight wide mobile four wide computer column">
                        <button :class="dataTransfertMediasLoading ? 'ui primary loading button' : (parseInt(sizeToTransfert) > 0 ? 'ui primary button' : 'ui disabled button')"
                                v-on:click="transfertMedias">{{ strings.menuTransfertMediasLabel }}</button>
                    </div>
                </div>
                ...
                AmCharts.makeChart("graphSizeLocal",
                    {
                        ...
                        "axes": [
                            {
                                "bottomText": filesInfo.sizeLocalFiles + " " + that.strings.megaBytesLabel,
                                "bottomTextYOffset": -20,
                                "endValue": 220,
                                "id": "GaugeAxis-1",
                                "topText": that.strings.sizeLocalFileLabel,
                                "valueInterval": 20,
                                "bands": [
                                    {
                                        "alpha": 0.7,
                ...
                AmCharts.makeChart("graphSizeDistant",
                    {
                        ...
                        "axes": [
                            {
                                "bottomText": filesInfo.sizeDistantFiles + " " + that.strings.megaBytesLabel,
                                "bottomTextYOffset": -20,
                                "endValue": 220,
                                "id": "GaugeAxis-1",
                                "topText": that.strings.sizeDistantFileLabel,
                                "valueInterval": 20,
                                "bands": [
                                    {
                                        "alpha": 0.7,
                ...
                AmCharts.makeChart("chartFilesBalance",
                    {
                        ...
                        "addClassNames": "true",
                        "dataProvider": [{
                            "name": that.strings.countLocalFilesLabel,
                            ...
                            "name": that.strings.countDistantFilesLabel,
