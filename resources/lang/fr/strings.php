...
return [
    ...
    'alert_top_fix_message' => 'Offre de lancement: Annonces Gratuites jusqu\'au 30/04/2018!!',
    ...
    'menu_invoice_create_delegation' => 'Facturer :delegateName',
    ...
    'mail_newInvoice_line2' => 'Voici la facture pour une retrocession de marge (:description)',
    ...
    'form_input_search_label3' => 'Cherchez par date (AAAA-MM-JJ), email, n°transation...',
    ...
    'divider_payment' => 'ou payer par Paypal',
    ...
    'option_intermediary_name' => 'Retrocession de marge sur la vente par l\'intermédiaire :name au client :customerName de :description. Marge Totale HT réalisée: :marge€. Taux de rétrocession = :rateValue%.',
    ...
    'view_all_test_account2' => 'Désolé, mais un seul rôle intermédiaire peut être désigné',
    ...
    'view_manage_adverts_photo_cost_label' => 'Prix d\'une photo supplémentaire (€ HT)',
    ...
    'view_manage_adverts_validity_costs_label' => 'Date de validité des tarifs',
    ...
    'view_manage_invoices_list_header_transaction_id' => 'N° Transaction',
    'view_manage_invoices_list_header_captured' => 'Réglée',
    'view_manage_invoices_list_header_voided' => 'Abandonnée',
    'view_manage_invoices_list_header_refunded' => 'Remboursée',
    ...
    'view_create_invoice_for_delegation_label' => 'Créer une Facture pour :delegateName',
    'view_create_invoice_for_delegation_modal_valid_header' => '== VALIDEZ LA CREATION D\'UNE FACTURE ==',
    'view_create_invoice_for_delegation_modal_valid_description1' => 'Vous êtes sur le point de créer une facture à :delegateName pour un montant de ',
    'view_create_invoice_for_delegation_modal_valid_description2' => '. Cliquez sur "NON" pour annuler. Cliquez sur "OUI" pour valider cette création',
    'view_create_invoice_for_delegation_form_description_label' => 'Nature de la vente (ex: 500 tshirts..)',
    'view_create_invoice_for_delegation_form_customer_label' => 'Nom du client final',
    'view_create_invoice_for_delegation_form_marge_label' =>  'Marge HT totale réalisée',
    'view_create_invoice_for_delegation_form_date_label' => 'Dater la facture au',
    'view_create_invoice_for_delegation_form_button_label' => 'Créer la facture',
    'view_create_invoice_for_delegation_goto_button_label' => 'Voir la facture',
    ...
    'view_user_account_alerts_label' => 'Alertes Email',
    'view_user_account_alert_before_end1_label' => 'Être alerté à J-' . env('ALERT_BEFORE_END_1') . ' avant la dépublication',
    'view_user_account_alert_before_end2_label' => 'Être alerté à J-' . env('ALERT_BEFORE_END_2') . ' avant la dépublication',
    'view_user_account_alert_end_label' => 'Être alerté quand mon annonce est dépubliée',
    ...
    'view_price_table_row_insertion' => 'Insertion de l\'annonce pour :lifetime jours',
    ...
    'payment_btn_check_card' => 'Vérifier',
    'payment_btn_valid' => 'Valider la commande',
    'payment_error_process' => 'Une erreur est survenue pendant La vérification avec la banque',
    'payment_form_invalid' => 'Les données renseignées pour la carte ne sont pas valides',
    'payment_card_invalid' => 'La vérification de votre carte a échoué',
    'payment_billing_description' => 'Petite Annonce avec option(s): ',
    ...
    'payment_generic_product_name' => 'Une annonce avec :nb option:|Une annonce avec :nb options:',
    'payment_all_error' => 'Ho non! Le paiement a échoué :-(',
    'payment_success' => 'Merci pour votre paiement. Notez que celui-ci ne sera éxécuté que si votre annonce est validée par nos services. Vous recevrez alors votre facture par mail.',
    ...
    'pdf_invoice_transactionId' => '(n° de transaction: :transactionid)',
