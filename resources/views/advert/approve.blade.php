...
@section('content')
    ...
    <approve-advert-form
            ...
            form-advert-price-coefficient-total-label="{{ trans('strings.view_advert_priceCoefficient_total_label') }}"
            ...
            advert-price-total-label="{{ trans('strings.view_advert_form_price_total_label') }}"
            advert-price-discount-label="{{ trans('strings.view_advert_form_discount_total_label') }}"
