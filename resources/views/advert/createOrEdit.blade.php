...
@section('content')
    ...
    <create-or-edit-advert-form
            ...
            advert-form-preview-header-label="{{ trans('strings.view_advert_preview_header_label') }}"
            advert-form-params-header-label="{{ trans('strings.view_advert_params_header_label') }}"
            ...
            advert-margin-header="{{ trans('strings.view_advert_form_margin_header') }}"
            category-field-required="{{ trans('strings.view_advert_form_category_field_required') }}"
            photo-field-required="{{ trans('strings.view_advert_form_photo_field_required') }}"
            ...
            default-breadcrumb="{{ trans('strings.view_advert_form_default_breadcrumb') }}"
            ...
            photo-swiper-first-header="{{ trans('strings.view_advert_form_photo_swiper_required') }}"
            photo-swiper-first-description="{{ trans('strings.view_advert_form_photo_swiper2_required') }}"
