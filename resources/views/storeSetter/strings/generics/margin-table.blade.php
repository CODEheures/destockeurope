<store-strings-setter
        strings="{{ json_encode([
                        'key' => 'margin-table',
                        'values' => [
                                'providerPrice' => trans('strings.view_advert_priceCoefficient_provider_price'),
                                'totalProviderPrice' => trans('strings.view_advert_priceCoefficient_total_provider_price'),
                                'newPriceLabel' => trans('strings.view_advert_priceCoefficient_new_price'),
