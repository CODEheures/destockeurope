...
<store-strings-setter
        strings="{{ json_encode([
                        ...
                        'values' => [
                                ...
                                'formValidationButtonLabel' => trans('strings.form_button_validation2'),
                                'formValidationButtonLabelc' => trans('strings.form_button_validation2c'),
                                'formValidationButtonLabeld' => trans('strings.form_button_validation2d'),
                                ...
                                'stepOneTitle' => isset($stepTitle) ?  $stepTitle : trans('strings.view_advert_steps_1_title'),
